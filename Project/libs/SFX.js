import { AudioListener, Audio, PositionalAudio, AudioLoader } from './three.module.js';
...
class SFX{
    ...
    load(name, loop=false, vol=0.5, modifier=1, obj=null){
    ...
    changeVolume(volume){
        Object.entries(this.sounds).forEach(sound => sound[1].setVolume(volume * sound[1].modifier));
    }
